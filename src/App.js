...
function App() {
  return (
    <div className="main" style={{ backgroundImage: "url('bild4.jpg')" }}>
      <div className="w-full p-4 bg-slate-300 grid grid-cols-3 gap-2">
        <Card
          title="Samuel Meusburger"
          description={"Arbeitslos"}
          imgUrl={"https://picsum.photos/200/300"}
        />
        <Card
          title="Julihan Deronja"
          description={"Putzkraft"}
          imgUrl={"https://picsum.photos/200/300"}
        />
        <Card
          title="LeonHard Feldkirch"
          description={"Langer"}
          imgUrl={"https://picsum.photos/200/300"}
        />
        <Card
          title="Eyüp Can Yilmaz"
          description={"Fenerbace Fan"}
          imgUrl={"https://picsum.photos/200/300"}
        />
        <Card
          title="Talher Yüschl"
